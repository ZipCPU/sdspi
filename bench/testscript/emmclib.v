...
localparam [31:0]	EMMC_RNONE   = 32'h00000000,
			EMMC_R1      = 32'h00000100,
			EMMC_R2      = 32'h00000200,
			EMMC_R1b     = 32'h00000300,
			EMMC_WRITE   = 32'h00000400,
			EMMC_MEM     = 32'h00000800,
			EMMC_FIFO    = 32'h00001000,
			EMMC_DMA     = 32'h00002000,
			EMMC_CMDBUSY = 32'h00004000,
			EMMC_ERR     = 32'h00008000,
			EMMC_CARDBUSY= 32'h00100000,
			EMMC_BUSY    = (EMMC_CARDBUSY | EMMC_CMDBUSY
							| EMMC_DMA | EMMC_MEM),
			EMMC_CMDERR  = 32'h00200000,
			EMMC_TFRERR  = 32'h00400000,
			EMMC_DMAERR  = 32'h01000000,
			EMMC_HWRESET = 32'h02000000,
			EMMC_ACK     = 32'h04000000,
			EMMC_BOOTACTV= 32'h08000000,
			EMMC_BOOTERR = 32'h10000000,
			EMMC_BOOTEN  = 32'h20000000;
