...
//
// Purpose:	This is the top level test bench for the SDIO controller, but
//		with the difference that this test bench instantiates an eMMC
//	card, rather than an SDIO card.
//
