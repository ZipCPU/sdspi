...
2.0 & 7/31/2026 & Gisselquist & eMMC Boot support, and trim registers\\\hline
\end{revisionhistory}
% Revision History
...
to be acceptable.  Note that in both HS200 and HS400 modes, this RX TRIM delay
is compared against a count that goes two per clock.  Hence, adjacent pairs
